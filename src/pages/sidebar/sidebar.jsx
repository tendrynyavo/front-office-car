  ...
  return (
    <>
        <section className="sidebar">
            ...
            <Intervalle handleChangeIntervalle={handleChangeIntervalle} title="Prix" min={'prixMin'} max={'prixMax'} inputValues={inputValues} />
            <Intervalle handleChangeIntervalle={handleChangeIntervalle} title="Annee" min={'anneeMin'} max={'anneeMax'} inputValues={inputValues} />
